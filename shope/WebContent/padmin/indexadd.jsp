				...
				<div id="r1">
					<div class="place">
					    ...
					    <div class="formtitle"><span>基本信息</span></div>
					     ...
					     <form action="/shope/addProduct" method="post" onsubmit="return checkform()">
						     <ul class="forminfo">
						    <li><label>商品名</label>
						    ...
						    <li><label>类别</label>
						    <input id="class_id" name="class_id" type="text" class="dfinput" value="请输入类别编号"/>
						    <span id="class_id_msg"></span>
						    </li>
						    
						    <li><label>价格</label>
						    <input id ="price" name="price" type="text" class="dfinput" value="xx.xx"/>
						    <span id="price_msg"></span>
						    </li>
						    
						    <li><label>库存量</label>
						    <input id="surplus_count" name="surplus_count" type="text" class="dfinput" />
						    <span id="sruplus_msg"></span>
						    </li>
						    
						    <li><label>关键词</label>
						    <input id="detail" name="detail" type="text" class="dfinput" /></li>
						    <li><label>&nbsp;</label>
